...
1.  When changing the lifecycle state of the created update from
    ...
    Click it.![IS logo](https://github.com/wso2-docs/IS/blob/master/103318264.png?raw=true?float="left")
2.  You get directed to a separate page as follows: 
3.  Click **GET UPDATE YAML** to see the YAML information as follows:  
    ![IS logo](https://github.com/appellj/TestWSO2UpdatesDoc/blob/master/updates/attachments/103318258/103318259.png?raw=true)
...
6.  You get a page as follows. Update it with the products relevant for
    your update number.  
      <img src="https://github.com/appellj/TestWSO2UpdatesDoc/blob/master/updates/attachments/103318258/103318259.png?raw=true" alt="image1" width="450" margin-left="5000px" />
